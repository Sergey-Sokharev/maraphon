...
?>	
	...
	<main id="primary" class="site-main" >
		<script>
		$("#maraphon_next,#telegram,#shopping_guide,#workout").prop('checked',false);
        ...
        $(document).on('click', '.register-sale-block-6', function (e) {
            ...
            if ($('#shopping_guide').prop('checked')) {
	...
	if ( is_user_logged_in() ) {
		...
		custom_registration_function();	
		    ...
		    if (isset($_POST['submit'])) {
		        ...
		        global $maraphon_next_month;
		        if (current_time("j") >= 29) {
		        	$maraphon_next_month = 	'марафон на '.$next_month.' '.$year.'г.';
		        } else if (current_time("j") < 8) {
			        $maraphon_next_month = 	'марафон на '.$this_month.' '.current_time("Y").'г.';
		        } else {
			        $maraphon_next_month = 	'месяц марафона не определен';
		        };
			...
			function confirmation_form( $maraphon_next_month ) {
			    ...
			    <form action="' . $_SERVER['REQUEST_URI'] . '" method="post" id="register_main_form">
				    <div class="register-sale-block">
				    	...
				    	<div class="register-sale-block-1">
				    		<h3>О МАРАФОНЕ</h3>
				    	<!--	<h3>Старт 29 '.$this_month_padezh.'
				    			<br>
					    		Длительность 30 дней
					    		<br>
					    		Что вас ждет:
					    	</h3> -->
					    	<h3>Старт 3 или 9 января
				    			<br>
					    		Длительность до 28 января
					    		<br>
					    		Что вас ждет:
					    	</h3>
					    	<p>	
					    	    - доступ к меню<br>
					    		- возможность получить доступ к меню для ваших мужчин<br>
			...
			function confirmation_validation( $maraphon_next_month )  {
			    global $reg_errors;
			...
			function complete_confirmation() {
			    global $wpdb, $reg_errors, $maraphon_next_month;
		    ...
		    if (isset($_POST['submit'])) {
		        ...
		        global $username, $password, $email, $telephone, $first_name, $last_name, $maraphon_next_month;
			...
			function registration_form( $password, $email, $telephone, $first_name, $last_name, $maraphon_next_month ) {
			    ...
			    <form action="' . $_SERVER['REQUEST_URI'] . '" method="post" id="register_main_form">
				    <div class="register-sale-block">
				    	...
				    	<div class="register-sale-block-1">
				    		<h3>О МАРАФОНЕ</h3>
				    	<!--	<h3>Старт марафона 29 '.$this_month_padezh.'
				    			<br>
					    		Длительность 30 дней
					    		<br>
					    		Что вас ждет:
					    	</h3> -->
					    	<h3>Старт марафона 3 или 9 января
				    			<br>
					    		Длительность до 28 января
					    		<br>
					    		Что вас ждет:
			...
			function registration_validation( $password, $email, $telephone, $first_name, $last_name, $maraphon_next_month )  {
			    global $reg_errors;
			    $reg_errors = new WP_Error;
			    $email = trim($email);
			...
			function complete_registration() {
			    global $wpdb, $reg_errors, $password, $email, $telephone, $first_name, $last_name, $maraphon_next_month;
			    if ( count($reg_errors->get_error_messages()) < 1 ) {
