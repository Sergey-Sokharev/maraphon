...
?>
  ...
  <div class="card-body">
	...
	<h5 class="card-title result-h5">Ниже калькулятор расчитал вашу норму калорий:</h5>
	...
	<div class="alert alert-warning" role="alert" id="gv-table-div">
		ВНИМАНИЕ! табличка не учитывает ГВ! Если вы на ГВ, то прибавьте к своим нормам дополнительное кол-во калорий и бжу!<br>
